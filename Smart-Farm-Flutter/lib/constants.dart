...
class AppConfig {
  // غير الرابط ده برابط الـ Ngrok بتاعك الجديد كل ما تشغل السيرفر
  static const String serverBaseUrl = 'https://unquailing-ardath-bilingually.ngrok-free.dev';
...
// قائمة الحساسات (تم حذف Water Flow)
