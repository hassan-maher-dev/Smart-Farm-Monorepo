...
import 'package:plant_monitor/widgets/chart_painter.dart';
import 'package:plant_monitor/screens/login_screen.dart';
import 'package:plant_monitor/main.dart'; // ✅ ضروري عشان themeNotifier
import 'package:flutter/material.dart';
import 'package:fl_chart/fl_chart.dart'; // 👈 استدعاء مكتبة الرسم البياني
import 'package:intl/intl.dart'; // 👈 استدعاء مكتبة الوقت
...
// -------------------- 1. Dashboard Screen (Exact Image Match) --------------------
class DashboardScreen extends StatelessWidget {
  ...
  Map<String, dynamic> _getWeatherStatus(bool isArabic) {
    ...
    // محاكاة لدرجة "Feels Like" (عادة بتكون أعلى شوية في المزارع بسبب الرطوبة)
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          // Header Card (اللوجو والساعة) - زي ما هو
          Card(
            elevation: 2,
          ...
          // ✅ كارت الطقس الجديد (نفس تصميم الصورة بالظبط)
          Card(
            elevation: 2,
                ...
                children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: weather['color'].withOpacity(0.1), // خلفية باهتة للأيقونة
                          shape: BoxShape.circle, // أو borderRadius: BorderRadius.circular(8) لمربع
                        ),
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 22, 
                      fontWeight: FontWeight.bold, 
                      color: weather['color'] // لون الحالة نفس لون الأيقونة
                    ),
                  ),
                  ...
                  const SizedBox(height: 24), // مسافة كبيرة قبل الأرقام
                  
                  // الصف الأخير: Feels Like و Temperature
                  Row(
                    children: [
                      // Feels Like
                      Column(
                      ...
                      const SizedBox(width: 40), // مسافة بين العمودين
...
// -------------------- 2. Sensors Screen (Live Dashboard) --------------------
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            children: [
              ...
              // 4. الرسم البياني جوه كارت منفصل
              Container(
                padding: const EdgeInsets.all(20),
                decoration: BoxDecoration(
                  color: cardBgColor, 
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height: 260, // ✅ كبرنا الارتفاع أكتر عشان يستوعب النص الطولي
                      ...
                      child: LineChart(
                        LineChartData(
                          ...
                          titlesData: FlTitlesData(
                            ...
                            // ✅ تعديل المحور الأفقي ليكون النص بشكل طولي
                            bottomTitles: AxisTitles(
                              sideTitles: SideTitles(
                                showTitles: true,
                                reservedSize: 60, // ✅ مساحة أكبر تحت الرسم البياني للنص الطولي
                                interval: 1, // ✅ عرض الوقت لكل قراءة بدون تفويت أي نقطة
                                getTitlesWidget: (value, meta) {
                                  ...
                                  if (index >= 0 && index < rawChartData.length) {
                                    ...
                                    return Padding(
                                      ...
                                      // ✅ ويدجت RotatedBox بتلف النص 90 درجة
                                      child: RotatedBox(
                                        quarterTurns: 3, // يقرأ من تحت لفوق
...
// ControlScreen Updated (Fixed Toggle Button)
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // ✅ الزرار ثابت ومش بيختفي، بيتغير لونه ووظيفته حسب الوضع
            ElevatedButton.icon(
              onPressed: () {
                if (isAuto) {
                  // لو تلقائي وعايزينه يدوي، نبعت نفس حالته الحالية عشان تتسجل في الداتابيز كـ manual بدون تغيير التشغيل
                  onControlDevice(key, isOn, duration: duration);
                } else {
                  // لو يدوي وعايزينه تلقائي
                  onSetAutoMode(key);
                }
              },
...
class AboutScreen extends StatelessWidget {
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            children: [
              ...
              // 4. فريق العمل (7 أعضاء - أسماء ثنائية - صور)
              _buildSectionCard(
                context, 
              ...
              // 5. المجالات التقنية (تم تحديث المسميات للمجالات الكبرى)
              Align(
  ...
  // ويدجت عضو الفريق المعدلة (صورة + اسم ثنائي)
  Widget _buildTeamMemberCard(BuildContext context, String name, bool isDark, Color? textColor) {
    return Container(
      width: (MediaQuery.of(context).size.width - 60) / 2.1, // لضمان ظهور 2 متجاورين
      padding: const EdgeInsets.all(8),
      decoration: BoxDecoration(
      ...
      child: Row(
        ...
        children: [
          CircleAvatar(
            ...
            // هنا تقدر مستقبلاً تحط صورة حقيقية كدا:
            // backgroundImage: AssetImage('assets/images/member_name.jpg'),
          ),
          const SizedBox(width: 8),
          Expanded(
            child: Text(
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void initState() {
    super.initState();
    // تحميل الاسم المحفوظ أول ما الصفحة تفتح
    _loadFarmName();
  }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          onChanged: _saveFarmName, // الحفظ التلقائي
...
// -------------------- 6. Notifications Screen (Smart State Tracking) --------------------
class NotificationsScreen extends StatelessWidget {
  ...
  List<Map<String, dynamic>> _generateAlerts(bool isArabic) {
    ...
    int lastTempState = 0;      // 0: Normal, 1: High
    int lastMoistureState = 0;  // 0: Normal, 1: Dry, 2: Watering
    ...
    for (var record in historicalData) {
      ...
      // 🔥 التعديل السحري هنا لمعالجة التاريخ بطريقة آمنة جداً 🔥
      String timeStr = '--:--';
      if (record['timestamp'] != null) {
        try {
          // بنحول النص لتاريخ الأول، وبعدين نحوله للتوقيت المحلي، وبعدين نفرمته
          DateTime parsedDate = DateTime.parse(record['timestamp'].toString()).toLocal();
          timeStr = DateFormat('hh:mm a').format(parsedDate);
        } catch (e) {
          timeStr = '--:--'; // لو حصل أي خطأ في التحويل
        }
      }
