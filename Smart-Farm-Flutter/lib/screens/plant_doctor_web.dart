  ...
  Future<void> _uploadAndAnalyze(Uint8List imageBytes, String fileName) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        try {
          detectedDisease = tomatoDiseases.firstWhere(
              (d) => d.modelLabel.toLowerCase() == label.toLowerCase());
        } catch (e) {
          detectedDisease =
              tomatoDiseases.firstWhere((d) => d.modelLabel == 'healthy');
        }
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content: Text(languageNotifier.value
                ? 'خطأ في الاتصال بالخادم السحابي'
                : 'Cloud Server Connection Error'),
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            Text(isArabic ? 'نصائح لنتيجة دقيقة' : 'Tips for Best Results',
                style:
        ...
        content: Column(
          ...
          children: [
            _buildTipItem(
                ...
                isArabic
                    ? 'قرب الكاميرا من الورقة المصابة فقط.'
                    : 'Focus close on the infected leaf.'),
            _buildTipItem(
                Icons.wb_sunny,
                isArabic
            ...
            _buildTipItem(
                Icons.wallpaper,
                isArabic
                    ? 'خلفية بسيطة (يفضل غير مزدحمة).'
                    : 'Use a clean, simple background.'),
            _buildTipItem(
                Icons.blur_off,
                isArabic
                    ? 'ثبت يدك لمنع اهتزاز الصورة.'
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            child: Text(isArabic ? 'ابدأ الفحص' : 'Start Scan',
      ...
      builder: (context) => SafeArea(
        child: Wrap(
          children: [
            ...
            ListTile(
              leading:
                  const Icon(Icons.photo_camera, color: AppColors.accentColor),
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  Text(isArabic ? 'سجل الفحوصات' : 'History (Last 20)',
              ...
              Expanded(
                child: _scanHistory.isEmpty
                    ? Center(
                        child: Text(
                            isArabic ? 'لا يوجد سجلات بعد' : 'No history yet',
                            style: const TextStyle(color: Colors.grey)))
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final disease = tomatoDiseases.firstWhere(
                            ...
                            orElse: () => tomatoDiseases
                                .firstWhere((d) => d.modelLabel == 'healthy'),
                          );
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              leading: ClipRRect(
                                ...
                                child: Image.asset(disease.imagePath,
                                    width: 50,
                                    height: 50,
                                    fit: BoxFit.cover,
                                    errorBuilder: (c, e, s) =>
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                  fontSize: 24,
                  fontWeight: FontWeight.bold,
                  color: disease.modelLabel == 'healthy'
                      ? Colors.green
                      : Colors.red),
              ...
              children: [
                Expanded(
                  ...
                  child: ElevatedButton(
                    ...
                    child:
                        const Icon(Icons.share, color: AppColors.accentColor),
                  ),
                ),
                const SizedBox(width: 10),
                Expanded(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    icon: const Icon(Icons.medical_services_outlined,
                        color: Colors.white),
                    label: Text(
                        isArabic ? 'التشخيص والعلاج' : 'Diagnosis & Treatment',
                        style:
          ...
          child: ListView(
            ...
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(isArabic ? 'خطة العلاج' : 'Treatment Plan',
                      style: TextStyle(
                          fontSize: 22,
                          fontWeight: FontWeight.bold,
                          color: textColor)),
              ...
              const SizedBox(height: 20),
              _buildSectionTitle(
                  isArabic ? '🔍 الأعراض والوصف' : '🔍 Symptoms'),
              Text(
                isArabic ? disease.descriptionAr : disease.description,
                style: TextStyle(
                    fontSize: 15,
              ...
              const SizedBox(height: 20),
              _buildSectionTitle(
                  isArabic ? '💊 خطوات العلاج' : '💊 Treatment Steps'),
              Container(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Text(isArabic ? 'فحص جديد' : 'New Scan',
            style: const TextStyle(color: Colors.white)),
              ...
              itemBuilder: (context, index) {
                if (index == 0) {
                  return Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(isArabic ? 'موسوعة الأمراض' : 'Disease Library',
                            style: TextStyle(
                                fontSize: 22,
                                fontWeight: FontWeight.bold,
                                color: textColor)),
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    title: Text(isArabic ? disease.nameAr : disease.name,
